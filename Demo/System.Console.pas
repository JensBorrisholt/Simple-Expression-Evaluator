...
type
  ...
  private
    ...
    class procedure SetCursorPos(const Value : TCoord); static;
...
class function Console.GetCursorPos: TCoord;
begin
...
class procedure Console.SetCursorPos(const Value: TCoord);
begin
  if not SetConsoleCursorPosition(ConsoleOutputHandle, Value) then
    RaiseLastOSError;
end;
